                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                await conn.sendMessage(conn.user.jid, '*-- HATA RAPORU [Babybot] --*' + 
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [Baby Bot] --*' + 
