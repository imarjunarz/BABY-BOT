...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
        ...
        r_text[1] = "https://i.ibb.co/7bdrrpF/Pics-Art-01-03-12-28-39.png";
        ...
        await message.client.sendMessage(message.jid, Buffer.from(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '𝘽𝙖𝙗𝙮 𝘽𝙤𝙩'})
